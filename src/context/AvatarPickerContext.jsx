...
export const AvatarPickerContext = createContext(genConfig());

export function AvatarPickerProvider({ children }) {
  ...
  const changeSkin = () =>
    updateAttribute('#fdba74,#fed7aa,#ffedd5', 'faceColor');

  const changeHair = () => {
    updateAttribute('normal,thick,mohawk,womanLong,womanShort', 'hairStyle', {
